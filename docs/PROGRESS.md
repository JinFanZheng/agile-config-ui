...
## v1.0.x 后续迭代（2026-09-08 起，用户驱动；09..21 经三路子代理验收、22..29 经单代理验收（含 install 实测与 CI 核对），报告见 evidence/ACCEPT-2026-09-08/ 与 ACCEPT-2026-09-08-2/）
...
| [ITER-29](iterations/ITER-29-install-ci.md) | install.sh Linux CI 矩阵（三形态产物断言）+ 模板升级语义定案 | — |
