...
|---|---|---|---|
| [ITER-02](ITER-02-theme-system.md) | 主题系统与通用基建 | 验收中（对齐反馈已修复，复验中） | T-08 用户复验（顶栏对齐修复 + 本轮规划确认） |
...
| ITER-02 | 主题系统与通用基建 | M0 增量 | — | 验收中 | [ITER-02-theme-system.md](ITER-02-theme-system.md) | `docs/evidence/ITER-02/` |
| ITER-03 | 应用管理 | M1 | 11 | PLANNED | [ITER-03-apps.md](ITER-03-apps.md) | — |
